<div id="pending_orders" class="menu-products-list-modal modal fade" role="dialog">
	    ...
	    <!-- Modal content-->
			...
			<div class="menu-footer">
				<div class="row menu-footer-buttons card">
					<button id="btn-entregar-pedidos" class="btn btn-main btnSave" data-url="<?= $this->url->get('waiter/deliverOrders') ?>" data-callname="btn-entregar-pedidos" data-table="<?= $cuenta->mesa_id ?>">ENTREGAR PEDIDOS</button>
				</div>
			</div>	
		    <?php } ?>
	    </div>
