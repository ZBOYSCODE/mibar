	...
	<section class="section-content-top">
   		<div class="row menu-types">
   			<div class="col-xs-4 col-sm-4 no-col-padding">
   				<div class="menu-type-item card" data-url="menu/changeMenu" data-categoria="0" data-callName="changeMenu">
   			...
   			<div class="col-xs-4 col-sm-4 no-col-padding">
   				<div class="menu-type-item card" data-url="menu/changeMenu" data-categoria="1" data-callName="changeMenu">
   			...
   			<div class="col-xs-4 col-sm-4 no-col-padding">
   				<div class="menu-type-item card" data-url="menu/changeMenu" data-categoria="2" data-callName="changeMenu">
